...
async def startup():
    ...
    from backend.scheduler import scheduler_loop, weekly_digest_loop, community_activity_loop, prediction_resolution_loop, auto_battle_loop, prediction_timeout_loop, domain_expert_loop, api_draft_loop, daily_email_loop
    ...
    asyncio.create_task(daily_email_loop())
